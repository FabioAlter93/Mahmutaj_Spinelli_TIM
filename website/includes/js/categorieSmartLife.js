function ready(){
    ...
    switch(parseInt(myParam)){
        case 1:
            var phpurl="includes/php/getCategorieProdotti.php";
            var urlCat="prodottiPerCategoria.html?idclasse=1";
            break;
        case 2:
            var phpurl="includes/php/getCategorieSmartLife.php";
            var urlCat="smartLifePerCategoria.html?idclasse=2";
            break;
        case 3:
            var phpurl="includes/php/getCategorieAssistenza.php";
    ...
    $.ajax({
        ...
        url: phpurl="includes/php/getCategorieProdotti.php";
        ...
        success: function(response) {
          ...
          for(i=0;i<categorieprodotti.length;i++){
                ...
                var urlCategoria = "prodottiPerCategoria.html?idcategoria=" +categorieprodotti[i].idcategoria;
                
                var imgTemp = document.createElement("img");
                
                var urlImmagine = "Immagini/" + categorieprodotti[i].fotocategoria;
