...
$.ajax({
		...
		url: "includes/php/getAssistanceRelatedDevice.php?id="+myParam,
		...
		success: function (response) {
			...
			for (i = 0; i < prodotti.length; i++) {
                ...
                var urlDevice = "deviceProdotti.html?idclasse=1?idCat=" + prodotti[i].idCat + "?idprodotti=" + prodotti[i].id;
